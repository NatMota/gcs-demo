...
export default function Home() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Hash of "permutive" = 687142121
    const correctPasswordHash = 687142121;
  ...
  if (isExpired) {
    // Return nothing - effectively deletes the page content
    return null;
  }
            ...
            <div className="flex justify-center mb-8">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Data Connectivity Platform</p>
                </div>
              </div>
            </div>
      ...
      <header className="bg-gray-900 border-b border-gray-700 h-12 flex items-center justify-between px-4">
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-gray-200">GCS Data Integration</span>
          </div>
        </div>
